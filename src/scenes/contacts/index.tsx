    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="my-5">
            (A Message from the web developer: 👋 Hey there! Thank you for
            taking the time to visit my web application. As the developer behind
            this website, I'm passionate about creating platforms to empower
            individuals and companies to promote their profiles and businesses.
            If you have any questions, suggestions or simply want to connect,
            please don't hesitate to use the form below to reach out. Thank you!
            ❤️)
          </p>
        </motion.div>
        ...
        <div className="mt-10 justify-between gap-10 md:flex">
          ...
          >
            <div className="w-full before:absolute before:-bottom-24 before:-right-32 md:before:content-icoachtext before:z-[-1]">
              <img
                src={ContactsGraphic}
                alt="ContactsGraphic"
